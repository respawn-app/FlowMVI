...
import pro.respawn.flowmvi.debugger.server.ui.widgets.RScaffoldDefaults.ContentFadeDistance
import pro.respawn.kmmutils.compose.annotate
import pro.respawn.kmmutils.compose.modifier.FadingEdge
import pro.respawn.kmmutils.compose.modifier.fadingEdge
...
fun RScaffold(
    ...
    Scaffold(
        ...
        modifier = modifier.thenIf(nestedScrollConnection != null) { nestedScroll(nestedScrollConnection!!) },
        bottomBar = bottomBar,
