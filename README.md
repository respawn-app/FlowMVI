...
<a href="https://star-history.dera.page/#respawn-llc/flowmvi&Date">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://star-history.dera.page/svg?repos=respawn-llc/flowmvi&type=Date&theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://star-history.dera.page/svg?repos=respawn-llc/flowmvi&type=Date" />
    <img alt="Star History Chart" src="https://star-history.dera.page/svg?repos=respawn-llc/flowmvi&type=Date" />
  </picture>
</a>
