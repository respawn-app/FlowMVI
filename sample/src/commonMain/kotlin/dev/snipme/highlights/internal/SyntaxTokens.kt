...
internal object SyntaxTokens {
    ...
    val C_KEYWORDS = FLOW_CONTROL_KEYWORDS + (
        "auto,case,char,const,default," +
            "double,enum,extern,float,goto,inline,int,long,register,short,signed," +
            "sizeof,static,struct,switch,typedef,union,unsigned,void,volatile"
        ).split(",")

    val COMMON_KEYWORDS = C_KEYWORDS + (
        "catch,class,delete,false,import," +
            "new,operator,private,protected,public,this,throw,true,try,typeof"
        ).split(",")

    val CPP_KEYWORDS = COMMON_KEYWORDS + (
    ...
    val RUST_KEYWORDS = FLOW_CONTROL_KEYWORDS + (
    ...
    val ALL_KEYWORDS =
        CPP_KEYWORDS + KOTLIN_KEYWORDS + CSHARP_KEYWORDS +
