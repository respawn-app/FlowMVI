...
internal inline fun <S : MVIState, I : MVIIntent, A : MVIAction> StorePlugin(
    ...
    @BuilderInference crossinline onUndeliveredIntent: UndeliveredHandlerContext<S, I, A>.(i: I) -> Unit = {},
    name: String? = null,
    ...
    override fun UndeliveredHandlerContext<S, I, A>.onUndeliveredIntent(
        intent: I
